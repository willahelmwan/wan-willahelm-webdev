...
app.post("/api/project/channel/:userId", createchannel);
app.get("/api/project/channels/:userId", findAllchannelsForUser);
app.get("/api/project/channel/:channelId", findchannelById);
app.put("/api/project/channel/:channelId", updatechannel);
app.delete("/api/project/channel/:userId/:channelId", deletechannel);
...
function deletechannel(req, res) {
    ...
    channelModel
        ...
        .then(function (status) {
            userModel.deleteChannelFromArray(userId, channelId)
            res.send(status);
        }, function (err) {
            res.send(err);
        });
